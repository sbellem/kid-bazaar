...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Kid.pic'
        db.alter_column(u'home_kid', 'pic', self.gf('cloudinary.models.CloudinaryField')(max_length=100, null=True))

        # Changing field 'Item.pic'
        db.alter_column(u'home_item', 'pic', self.gf('cloudinary.models.CloudinaryField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Kid.pic'
        raise RuntimeError("Cannot reverse this migration. 'Kid.pic' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Kid.pic'
        db.alter_column(u'home_kid', 'pic', self.gf('cloudinary.models.CloudinaryField')(max_length=100))

        # User chose to not deal with backwards NULL issues for 'Item.pic'
        raise RuntimeError("Cannot reverse this migration. 'Item.pic' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Item.pic'
        db.alter_column(u'home_item', 'pic', self.gf('cloudinary.models.CloudinaryField')(max_length=100))
    ...
    models = {
        ...
        u'home.item': {
            ...
            'pic': ('cloudinary.models.CloudinaryField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2'}),
            'used_till': ('django.db.models.fields.DateField', [], {'blank': 'True'})
        },
        u'home.itemrequest': {
