...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.used_till'
        db.delete_column(u'home_item', 'used_till')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Item.used_till'
        raise RuntimeError("Cannot reverse this migration. 'Item.used_till' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Item.used_till'
        db.add_column(u'home_item', 'used_till',
