...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Kid.birthday'
        db.alter_column(u'home_kid', 'birthday', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Kid.birthday'
        raise RuntimeError("Cannot reverse this migration. 'Kid.birthday' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Kid.birthday'
        db.alter_column(u'home_kid', 'birthday', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'home.item': {
            ...
            '_is_paid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'home.itemrequest': {
            ...
            'status': ('django.db.models.fields.TextField', [], {'default': "'PENDING_CONFIRMATION'"})
        },
        u'home.kbuser': {
